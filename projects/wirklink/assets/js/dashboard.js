...
$(document).ready(function() {
    for(let i = 1; i < 4; i++){
        ...
        document.getElementsByClassName("delete-image")[i-1].addEventListener("click", function(e) {
            ...
            if(i == 1) document.getElementById("image-"+ i +"-preview").src = "assets/images/cover-image.png";
            else document.getElementById("image-"+ i +"-preview").src = "assets/images/image-upload.png";
    ...
    for(let i = 1; i < 4; i++){
        ...
        document.getElementsByClassName("edit-delete")[i-1].addEventListener("click", function(e) {
            ...
            document.getElementById("edit-image-"+ i +"-preview").src = "assets/images/image-upload.png";
...
function loadAdDetails(id){
    for(let i = 1; i < 4; i++) document.getElementById("edit-image-" + i + "-preview").src = "assets/images/image-upload.png";
...
function verifyUser(verified, reviewed){
    ...
    if(!verified){
        ...
        document.getElementById("review-modal-image").src = "assets/images/account-review.jpg";
    }
